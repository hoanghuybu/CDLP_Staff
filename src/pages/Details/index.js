        ...
        <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
                    <span class="text-muted fw-light">Post/</span> Details
                </h4>
                <div className="row">
                        ...
                        <div className="card mb-4">
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-company">
                                            Company
                                        </label>
                                        <div className="col-sm-10">
                                            <input
                                    ...
                                    <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-message">
                                            Message
                                        </label>
                                        <div className="col-sm-10">
                                            <textarea
